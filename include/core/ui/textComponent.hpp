...
public:
    TextComponent(EngineContext *engine_context, Font *font, const std::string &text = "",
                  const TextRenderOptions &text_options = TextRenderOptions{});
    ...
    glm::vec2 getSize() const override { return drawable_string.dimensions; }
